...
// ===== CREAR GUERREROS =====
const jonSnow = new Guerrero("Jon Snow", 25, casaStark, espadaLargo);
const robbStark = new Guerrero("Robb Stark", 22, casaStark, new Arma("Hielo", 27, "Espada"));

const jaimeLannister = new Guerrero("Jaime Lannister", 35, casaLannister, espadaValyria);
const gregoryClegane = new Guerrero("La Montaña", 40, casaLannister, hacha);

const daenerys = new Guerrero("Daenerys Targaryen", 23, casaTargaryen, new Arma("Daga de Dragón", 20, "Daga"));
const jorah = new Guerrero("Jorah Mormont", 45, casaTargaryen, lanza);

const robert = new Guerrero("Robert Baratheon", 42, casaBaratheon, new Arma("Martillo de Guerra", 35, "Martillo"));
...
// 10. Contar guerreros con y sin aliados
console.log("\n" + "=".repeat(50));
console.log("        ESTADÍSTICAS DE GUERREROS");
console.log("=".repeat(50));

console.log(`Casa Stark: ${casaStark.contarGuerreros(false)} guerreros propios`);
console.log(`Casa Stark (con aliados): ${casaStark.contarGuerreros(true)} guerreros totales`);